...
is
   ...
   package Label_return_Handler is new Handlers.return_Callback (Gtk_Label_Record, Boolean);
   ...
   package comboBox_Text_Handler is new Handlers.Callback (Gtk_Combo_Box_Text_Record);
   ...
   package Entry_Handler    is new Handlers.Callback (Gtk_Entry_Record);
--     package Text_Handler     is new Handlers.Callback (Gtk_Text_Record);
   package Textview_Handler is new Handlers.Callback (Gtk_Text_View_Record);
