...
package body aIDE.Palette.of_types_subpackages
is
   use Adam;
   ...
   type button_Info is
      record
--           package_Name  : Text;
         Self          : aIDE.Palette.of_types.view;
...
--                                 +the_Info.package_Name,
   ...
   is
      Self        : constant Palette.of_types_subpackages.view := new Palette.of_types_subpackages.item;
   ...
   function new_Button (Named              : in String;
                        ...
                        the_Exception      : in AdaM.a_Type.view) return gtk.Button.gtk_Button
   is
      full_Name  : constant String    := package_Name & "." & Named;
      the_Button : gtk_Button;
   begin
