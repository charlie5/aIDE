...
package body aIDE.Editor.of_fixed_type
is
   use Gtk.Builder,
   ...
   function on_name_Entry_leave (the_Entry : access Gtk_Entry_Record'Class;
                                 Target    : in     AdaM.a_Type.ordinary_fixed_point_type.view) return Boolean
   is
   ...
   procedure on_rid_Button_clicked (the_Button : access Gtk_Button_Record'Class;
                                    the_Editor : in     aIDE.Editor.of_fixed_type.view)
   is
...
--        Self.Target.add_Literal ("literal");
   ...
   is
      ...
      is
         ...
         Self        : constant Editor.of_fixed_type.view := new Editor.of_fixed_type.item;
      ...
      begin
         ...
         Gtk_New (the_Builder);
         Result := the_Builder.Add_From_File ("glade/editor/fixed_type_editor.glade", Error'Access);
