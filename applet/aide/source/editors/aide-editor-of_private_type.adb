...
package body aIDE.Editor.of_private_type
is
   use Gtk.Builder,
   ...
   function on_name_Entry_leave (the_Entry : access Gtk_Entry_Record'Class;
                                 Target    : in     AdaM.a_Type.private_type.view) return Boolean
   is
...
--        Target.Last_is (Long_Long_Float'Value (the_Text));
   ...
   procedure on_rid_Button_clicked (the_Button : access Gtk_Button_Record'Class;
                                    the_Editor : in     aIDE.Editor.of_private_type.view)
   is
...
--        the_Button.get_Parent.destroy;
   ...
   function on_is_Label_clicked (the_Label : access Gtk_Label_Record'Class;
                                 Self      : in     aIDE.Editor.of_private_type.view) return Boolean
   is
...
--        Self.Target.add_Literal ("literal");
   ...
   is
      ...
      is
         ...
         Self        : constant Editor.of_private_type.view := new Editor.of_private_type.item;
