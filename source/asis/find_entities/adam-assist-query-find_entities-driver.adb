...
begin
   ada.Wide_Text_IO.new_Line (5);
   ada.Wide_Text_IO.put_Line ("FIND ENTITIES");
   ...
   AdaM.Assist.Query.find_Entities.context_Processing.Process_Context (The_Context => My_Context,
                                                                  Trace       => False);
...
end AdaM.Assist.Query.find_Entities.Driver;
